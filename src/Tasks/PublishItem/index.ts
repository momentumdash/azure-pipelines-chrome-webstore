...
import {ChromeStorePublishTarget} from '../../common/WebstoreApiOperations';
...
async function run() {
	try {
		...
		let itemDetails: any = await webstoreOperations.publishItem(itemId, ChromeStorePublishTarget.Default, accessToken);
